...
<div class="bg-white rounded-lg px-8 py-6 overflow-x-scroll mb-12">
    ...
    <div class="flex items-center justify-between mb-5">
        ...
        <a id="btnTambahTerapis"
           class="openModal cursor-pointer inline-flex items-center gap-2 bg-blue-600 hover:bg-opacity-90 text-white text-sm font-medium px-4 py-2 rounded-lg shadow transition duration-200">
        ...
        <div class="w-full max-w-xl max-h-[90vh] flex flex-col rounded-2xl bg-white shadow-xl overflow-hidden">
            ...
            <!-- Body -->
            <form id="formTambahTerapis" class="space-y-4 px-6 py-5 overflow-y-auto">
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        rows="2"
                        class="w-full rounded-lg border px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                        placeholder="Contoh: Jl. Veteran 10, Banyuwangi" value=""></textarea>
                </div>
                ...
                <div>
                    ...
                    <select 
                        ...
                        id="keahlian"
                        class="w-full rounded-lg border px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500">
                        <option value="">Pilih keahlian terapis</option>
                    </select>
                </div>
...
<div class="w-full max-w-md rounded-2xl bg-white shadow-xl">
    ...
    <!-- Body -->
<!-- Body -->
<form id="formEditTerapis" class="space-y-4 px-6 py-5">
    <div>
        <label class="mb-1 block text-sm font-medium text-gray-700">
            Nama Lengkap
        </label>
    ...
    <div>
        ...
        <textarea name="alamat" id="alamat" cols="10" rows="10" class="w-full rounded-lg border px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500">
        </textarea>
    </div>
    <div>
        <label class="mb-1 block text-sm font-medium text-gray-700">
...
<div class="w-full max-w-md rounded-2xl bg-white shadow-xl">
    ...
    <table class="w-full my-8 whitespace-nowrap" id="tabel_terapis">
        <thead>
            <tr>
...
@push('bottom')
    <script>
       ...
       let table = $('#tabel_terapis').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('data-terapis.datatables') }}"
        },
        columns: [
        ...
        // Open modal
        $('#btnTambahTerapis').on('click', function () {
            $('#modalTambahLayanan')
                .removeClass('hidden')
                .addClass('flex');
        });
        ...
        $('#formTambahTerapis').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    // Tutup modal
                    $('#modalTambahTerapis').addClass('hidden').removeClass('flex');
            ...
            // OPEN MODAL EDIT
            $(document).on('click', '.btnEditTerapis', function () {
                let id   = $(this).data('id');
            ...
            $(document).on('click', '.btnDeleteTerapis', function () {
