...
<div class="bg-white rounded-lg px-8 py-6 overflow-x-scroll custom-scrollbar mb-12">
    ...
    <a id="btnTambahLayanan"
       class="openModal cursor-pointer hover:cursor-pointer inline-flex items-center gap-2 bg-primary hover:bg-opacity-90 text-white text-sm font-medium px-4 py-2 mb-4 rounded-lg shadow transition duration-200">
