...
<header id="header" class="bg-base-200 transition-all duration-300 fixed">
    <div class="container mx-auto flex justify-between items-center p-3">
        <div class="flex items-center">
            <a href="{{ url('/') }}"><img src="{{ url(asset('assets/img/logo-landscape.png')) }}" alt="Logo" class="mr-3" style="width:200px;height:70px" /></a>
        </div>
