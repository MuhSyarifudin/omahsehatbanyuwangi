...
<div class="bg-gray-200 w-full min-h-screen flex items-center justify-center">
    <div class="w-full py-8">
        ...
        <div class="bg-white w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg shadow-2xl">
            ...
            <p class="text-center text-sm text-gray-600 mt-2">Don't have an account yet? <a href="{{ route('register') }}" class="text-primary hover:text-primary-dark hover:underline" title="Sign Up">Sign up here</a></p>
            ...
            <form class="my-8 text-sm" method="POST" action="{{ route('login') }}">
                ...
                <div class="my-4 flex items-center justify-end space-x-4">
                    <a href="{{ route('password.request') }}" class="text-gray-700 hover:text-gray-900 hover:underline">Forgot your password?</a>
                ...
                <div class="my-4 flex justify-center text-center">
                    <a href="{{ route('verification.form') }}" class="text-gray-700 hover:text-gray-900 hover:underline">Resend Verification Email</a>
                </div>
