             ...
             <!-- start:Page content -->
                <div class="bg-white rounded-lg shadow-xl pb-8">
                    ...
                    <div class="w-full h-[250px]">
                        <img src="{{ url(asset('assets/img/profile-background.jpg')) }}" class="w-full h-full rounded-tl-lg rounded-tr-lg">
                    </div>
                    <div class="flex flex-col items-center -mt-20">
                        <img src="{{ url($user->avatars ? asset('storage/'.$user->avatars) : asset('assets/img/blank-profile.png')) }}" class="w-40 border-4 border-white rounded-full">
                        ...
                        <p class="text-gray-700">IT Support at Omah Sehat Banyuwangi</p>
                        <p class="text-sm text-gray-500">Banyuwangi, Indonesia</p>
                    </div>
                        ...
                        <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                            ...
                            <ul class="mt-2 text-gray-700">
                                ...
                                <li class="flex border-b py-2">
                                    ...
                                    <span class="text-gray-700">4 Januari 2000</span>
                                </li>
                                <li class="flex border-b py-2">
                                    <span class="font-bold w-24">Joined:</span>
                                    <span class="text-gray-700">{{ dateid('j F Y',strtotime($user->created_at)).',('.$user->created_at->diffForHumans().')' }}</span>
                                </li>
                                <li class="flex border-b py-2">
                                    <span class="font-bold w-24">Mobile:</span>
                                    <span class="text-gray-700">083854371172</span>
                                </li>
                                <li class="flex border-b py-2">
                                ...
                                <li class="flex border-b py-2">
                                    ...
                                    <span class="text-gray-700">Banyuwangi, Indonesia</span>
                                </li>
                                <li class="flex border-b py-2">
                                    <span class="font-bold w-24">Languages:</span>
                                    <span class="text-gray-700">Bahasa Indonesia, English</span>
                                </li>
                ...
                <div class="bg-white rounded-lg shadow-xl p-8">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-8 mt-8">
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection1.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection2.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection3.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection4.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection5.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection6.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection7.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection8.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection9.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection10.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection11.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection12.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection13.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection14.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection15.jpg" class="w-16 rounded-full">
                        ...
                        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary" title="View Profile">
                            <img src="./../assets/img/connections/connection16.jpg" class="w-16 rounded-full">
